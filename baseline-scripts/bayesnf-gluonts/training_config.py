...
class TrainingConfig:
    ...
    num_unique_patches: int = 20

    patch_origins: str = 'data/non_overlapping_patches_96.pickle'
    ...
    # Validate using 1/2 Day(s) of Data
    num_val_batches: int = 65
    
    # Test using 7 Day of Data
    num_test_batches: int = 785
    ...
    # eval_patch_top_left_cell: tuple[int, int] = (2000, 300)
    # eval_patch_top_left_cell: tuple[int, int] = (1000, 1000)
    ...
    spatial_embedding_size: int = 96  # 16: 32, 32: 32, 64: 32, 80: 64, 96: 96, 128: 128, 228: 128
    linear_layer_size: int = 64 # 16: 36, 32: 25, 64: 16, 80: 36, 96: 64, 128: 144, 228: 625
    dropout: float = 0 # 0.25
    
    covariate_dimension: int = 4 # 7
