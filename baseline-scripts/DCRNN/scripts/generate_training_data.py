...
def generate_graph_seq2seq_io_data(
        df, x_offsets, period_offsets, y_offsets, add_time_in_day=True, add_day_in_week=False, scaler=None
):
    """
    ...
    print('min_t:',min_t)
    print('max_t:',max_t)
    print('x_offset:',x_offsets)
    print('y_offset:',y_offsets)
    print('period offset',period_offsets)
    for t in range(min_t, max_t):
        x_t_r = data[t + x_offsets, ...]
        #x_t_p = data[t + period_offsets, ...]
        #if(t==min_t):
        #    print('x_t_r shape',x_t_r.shape)
        #    print('x_t_p shape',x_t_p.shape)
...
def generate_train_val_test(args):
    ...
    #val_shape = 13
    num_test = 157#156#round(num_samples * 0.2)
    num_train = 1944#round(num_samples * 0.7)
    num_val = 13
    ...
    # val
    x_val, y_val = (
        x[num_train+num_test: num_train+num_test+num_val],
        y[num_train+num_test: num_train+num_test+num_val],
    )
    # test
